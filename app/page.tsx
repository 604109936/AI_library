  ...
  return (
    <main className="relative flex min-h-[100dvh] flex-col items-center justify-start overflow-hidden bg-moon dark:bg-dark-bg">
      ...
      <div className="relative left-[10px] z-10 mt-[calc(6vh+58px)] flex transform-gpu flex-col items-center px-8 text-center">
        ...
        <h1 className="mt-4 font-serif text-lg tracking-[0.08em] text-[#384a40] dark:text-dark-text">AI 图书馆</h1>
        <p className="mt-2.5 max-w-[340px] text-xs font-medium leading-6 text-celadon-700 dark:text-dark-text/85">
          一座懂你的智慧图书馆
          <br />
          汇尽古今好书，伴你在阅读中遇见自己
        </p>
